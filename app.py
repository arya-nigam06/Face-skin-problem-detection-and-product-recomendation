...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "The Skin Type is Classified as ACNE","result1.html"        
    elif result == 1:
        return "The Skin Type is Classified as SPOTS","result2.html"
    elif result == 2:
        return "The Skin Type is Classified as WRINKLES","result3.html"
...
def signup():
    ...
    msg['Subject'] = 'OTP'
    msg['From'] = "rajatg7803@gmail.com"
    msg['To'] = email
    
    
    s = smtplib.SMTP('smtp.gmail.com', 587)
    s.starttls()
    s.login("rajatg7803@gmail.com", "gymeopzncdgqdetz")
    s.send_message(msg)
    s.quit()
